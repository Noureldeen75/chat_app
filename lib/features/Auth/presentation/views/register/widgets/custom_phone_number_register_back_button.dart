...
class CustomPhoneNumberRegisterBackButton extends StatelessWidget {
  const CustomPhoneNumberRegisterBackButton({super.key});
    ...
    return Align(
      ...
      child: InkWell(
          onTap: AuthCubit.get(context)
              .togglePhoneNumberRegistrationStepsBoxContent,
          child: Container(
