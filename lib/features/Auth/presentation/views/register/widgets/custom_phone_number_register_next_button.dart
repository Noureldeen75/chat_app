...
class CustomPhoneNumberRegisterNextButton extends StatelessWidget {
  const CustomPhoneNumberRegisterNextButton({super.key});
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: InkWell(
          onTap: AuthCubit.get(context).togglePhoneNumberRegistrationStepsBoxContent,
          child: Container(
